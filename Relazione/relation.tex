...
Il lavoro propone una possibile implementazione di alcune delle tecniche di preprocessing applicate ai problemi di ottimizzazione lineare misto-interi (MIP). Per validare la correttezza del software è stato realizzato un generatore randomico di problemi MIP da sottomettere poi in AMPL. 
...
\begin{itemize}
\item Riduzione dei bound delle variabili
\item Ricerca di vincoli non soddisfacibili
\item Eliminazione di vincoli ridondanti
\item Fissaggio delle variabili
\item Riduzione dei coefficienti nei problemi BIP (binary integer program)
\end{itemize}
%----------------------------------------------------------------------------------------
